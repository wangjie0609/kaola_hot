...
class NKaola(object):
    ...
    def __init__(self):
        self.url1 = 'https://pages.kaola.com/pages/region/detail/8574/1005,1005,1005/141849,347457,217028.html?'
        self.url2 = 'https://pages.kaola.com/pages/region/detail/8574/1005,1005,1005/339952,352918,227489.html?'
        self.url3 = 'https://pages.kaola.com/pages/region/detail/8574/1005/347539.shtml?'
        self.headers = {
    ...
    def to_xml(self,item):
        ...
        worksheet = workbook.add_sheet('nine_nine')
        ...
        # 保存
        workbook.save(str(self.timee)+'_nine_nine.xls')
        print('---xml success')
    ...
    def main(self):
        ...
        fp = open(str(self.timee)+'_nine_nine.json', 'w')
